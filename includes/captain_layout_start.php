...
$bpis_page_title = $bpis_page_title ?? 'Barangay Captain';
...
if (!isset($user_fullname) || !isset($user_role)) {
    if (isset($conn) && $conn instanceof mysqli) {
        ...
        $user_fullname = $user_fullname ?? 'Captain';
...
<?php else: ?>
        <div class="captain-page-scroll custom-scrollbar flex-grow min-h-0 w-full">
<?php endif; ?>
