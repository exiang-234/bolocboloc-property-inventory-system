...
$bpis_page_title = $bpis_page_title ?? 'Secretary';
...
if (!isset($user_fullname) || !isset($user_role)) {
    if (isset($conn) && $conn instanceof mysqli) {
        ...
        $user_fullname = $user_fullname ?? 'Secretary';
...
<head>
    ...
    <link rel="stylesheet" href="../css/secretary_shell.css">
    <link rel="stylesheet" href="../css/secretary_mobile_sidebar.css">
    <?php include __DIR__ . '/bpis_profile_dropdown_head.php'; ?>
    <?php include __DIR__ . '/bpis_logout_modal_head.php'; ?>
    <link rel="stylesheet" href="../css/secretary_content.css">
...
<?php include __DIR__ . '/bpis_logout_modal.php'; ?>
    ...
    <div class="sidebar">
        <div class="sidebar-top">
            ...
            <?php include __DIR__ . '/secretary_sidebar.php'; ?>
        </div>
...
<?php else: ?>
        <div class="secretary-page-scroll custom-scrollbar flex-grow min-h-0 w-full">
<?php endif; ?>
